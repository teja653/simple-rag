...
Why this model? See Models Used & Why section.
...
Select the database rag_db and collection documents.
...
OPENROUTER_API_KEY	Your API key from OpenRouter — required for LLM access
...
Follow the steps in MongoDB Atlas Vector Search Setup.
Running the Application
...
Wait for the "PDF uploaded and processed!" success message.
Type your question in the text input and click Send.
The bot will answer based on the content of your uploaded PDF.
API Endpoints
